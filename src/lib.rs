...
fn main() {
    ...
    #[wasm_bindgen]
    // Let's define the universe. The universe has a width and a height, and a vector of cells of length width * height
    pub struct Universe {
        width: u32,
        height: u32,
        cells: Vec<Cell>,
    ...
    impl Universe {
            ...
            for row in 0..self.height {
                for col in 0..self.width {
                    ...
                    let next_cell = match (cell, live_neighbors) {
                        ...
                        (Cell::Alive, 2) | (Cell::Alive, 6) => Cell::Alive,
        ...
        pub fn new() -> Universe {
            ...
            let cells = (0..width * height)
                .map(|i| {
                    if (i % 2 == 0 || i % 7 == 0) && js_sys::Math::random() < 0.5 {
                        Cell::Alive
                    } else {
                        Cell::Dead
                    }
